...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://login.wholefoodsmarket.com";
...
if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "djipmonmiajlocdcdkam";
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://login.wholefoodsmarket.com";
janrain.settings.permissions = ["customizable_auth_widget_hide_attribution","customizable_auth_widget_styling"];
if (typeof janrain.settings.providers === 'undefined')janrain.settings.providers = ["facebook","googleplus","twitter","yahoo"];
if (typeof janrain.settings.noReturnExperience === 'undefined')janrain.settings.noReturnExperience = false;
if (typeof janrain.settings.facebookAppId === 'undefined')janrain.settings.facebookAppId = "279722332039196";
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://login.wholefoodsmarket.com";
...
if (typeof janrain.settings.share.providers === 'undefined')janrain.settings.share.providers = ["email","facebook","twitter","yahoo"];
if (typeof janrain.settings.share.providersEmail === 'undefined')janrain.settings.share.providersEmail = ["google"];
